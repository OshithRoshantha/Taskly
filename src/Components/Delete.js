...
export default function Delete({hideDeleteContainer,closeOpenTask,taskTitle}) {
  return (
    <div className='addContainer pt-3 ps-3 deleteContainer'>
       ...
       <div className="buttonContainer pb-3 pe-2 d-flex justify-content-end">
            ...
            <Button onClick={closeOpenTask} variant='danger' className='text-info mx-2'>Delete</Button>
       </div>      
    </div>
  )
}
